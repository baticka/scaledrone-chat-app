...
var getMemberName = function getMemberName() {
  ...
  return "".concat(firstName[getRandomInt()], " ").concat(lastName[getRandomInt()]);
};

/* Get random color for each member name */
var getMemberColor = function getMemberColor() {
  element = 256;
  return "rgb(".concat(getRandomInt(), ", ").concat(getRandomInt(), ", ").concat(getRandomInt(), ")");
};
var drone = new Scaledrone("USZQvKl3q84qn0Yy", {
  data: {
    name: getMemberName(),
...
drone.on('open', function (error) {
  ...
  room.on('members', function (member) {
    members = member;
    updateMembers();
  });
  ...
  room.on('member_leave', function (_ref) {
    var id = _ref.id;
...
var updateMembers = function updateMembers() {
  membersList.innerHTML = '';
  members.forEach(function (member) {
    return membersList.appendChild(createMemberElement(member));
  });
};

/* Create new member and assign color to name */
var createMemberElement = function createMemberElement(member) {
...
var createMessageElement = function createMessageElement(data, member) {
  var newMember = createMemberElement(member),
